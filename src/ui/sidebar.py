...
hyperparameters = get_navbar_btn("7. HYPERPARAMETERS")
gpu = get_navbar_btn("8. GPU")
export = get_navbar_btn("9. EXPORT")
evaluate = get_navbar_btn("10. EVALUATION")
train = get_navbar_btn("11. TRAIN")
# start = get_navbar_btn("START")
