...
from sly_sdk.geometry.conversions import shapely_figure_to_coords_list
...
from sly_sdk.geometry.vector_geometry import VectorGeometry
...
class Polygon(VectorGeometry):
    ...
    def area(self) -> float:
        ...
        interior_area = 0
        for hole in self.interior_np:
            interior_area += self._get_area_by_gauss_formula(hole[:, 0], hole[:, 1])
